    ...
    <>
      <div style={{ backgroundColor: "#f7fbfc", minHeight: "100vh", padding: "20px" }}>
        <Container maxWidth="sm" style={{ marginTop: "40px", maxWidth: "700px" }}>
          ...
          >
            <img src={decline} alt="Decline" style={{ width: 100, height: 100, marginBottom: 16 }} />
            ...
            <Paper elevation={0} sx={{ bgcolor: "#f8fbfc", p: 3, borderRadius: 2, mb: 3, textAlign: "left" }}>
              <Typography variant="h6" style={{ color: "black", fontWeight: "bold", marginBottom: 16 }}>
                Common reasons for decline:
              </Typography>
              <Box component="ul" sx={{ color: "#4a4a4a", listStyleType: "none", p: 0, m: 0 }}>
                <li style={{ marginBottom: 8 }}>• Device is older than our coverage eligibility criteria</li>
                <li style={{ marginBottom: 8 }}>• Pre-existing damage detected on the device</li>
                <li style={{ marginBottom: 8 }}>• Device model not currently covered under our policies</li>
                <li style={{ marginBottom: 8 }}>• Information provided could not be verified</li>
              </Box>
            </Paper>

            <Paper elevation={0} sx={{ bgcolor: "#f0f6ff", p: 3, borderRadius: 2, mb: 3, border: "1px solid #eaedf8" }}>
              <Typography variant="h6" style={{ color: "black", fontWeight: "bold", marginBottom: 8 }}>
